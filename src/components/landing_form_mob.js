...
const landing_page_mob = `<div id='crmWebToEntityForm' class='zcwf_lblTopBottom crmWebToEntityForm'
style='background-color: white;color: black;max-width: 900px; width: 450px;'>
...
const LandingFormMob = () => <div dangerouslySetInnerHTML={{ __html: landing_page_mob }} />;

export default LandingFormMob;